...
*/
class CustomAnnotationArc extends React.Component {
    componentDidMount() {
        WebViewer(
            {
                path: '/webviewer/lib',
            ...
            class TriangleAnnotation extends Annotations.CustomAnnotation {
                constructor() {
                    ...
                    console.log("How often is this being called?")
                }

                draw(ctx, pageMatrix) {
                    console.log("Arc Vertex Info");
            ...
            class TriangleCreateTool extends Tools.GenericAnnotationCreateTool {
                ...
                mouseLeftDown(e) {
                    ...
                    //console.log(e);
                    console.log(`What is the Count ${this.count}`);

                    if (this.count < 3) {
                        this.annotation.vertices[this.count].x = this.annotation.X;
                        this.annotation.vertices[this.count].y = this.annotation.Y;
...
export default CustomAnnotationArc;